...
import { 
  ...
  faSearch,
  faGraduationCap,
  faBullhorn, // استخدام faBullhorn بدلاً من faMegaphone
  faProjectDiagram // استخدام faProjectDiagram بدلاً من faNetworkWired
          ...
          <div dir="rtl" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
            ...
            <section className="text-center mb-20">
              ...
              >
                <div className={`w-32 h-32 rounded-full mx-auto mb-6 flex items-center justify-center ${
                  ...
                  <FontAwesomeIcon icon={faUsers} className="text-white text-5xl" />
                </div>
                ...
                <p className={`text-2xl max-w-3xl mx-auto leading-relaxed mb-8 ${
                  ...
                  منصة <span className="font-bold gradient-text">Lkhadma</span> هي منصة مغربية رقمية متخصصة في ربط الباحثين عن العمل بالشركات، المقاولات، والحرفيين
                </p>
              </motion.div>
            </section>
            ...
            <section className="mb-20">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                >
                  ...
                  <p className={`text-lg leading-relaxed ${darkMode ? 'text-blue-100' : 'text-blue-900'}`}>
                    تقديم منصة رقمية حديثة تُسهّل عملية التوظيف، وتمنح الجميع فرصة عادلة للوصول إلى العمل المناسب، مع ضمان تجربة استخدام آمنة وسلسة.
                  </p>
                </motion.div>
                ...
                >
                  <div className="flex items-center mb-6">
                    <div className={`w-14 h-14 rounded-xl bg-gradient-to-br from-purple-500 to-pink-400 flex items-center justify-center ml-4`}>
                      <FontAwesomeIcon icon={faEyeIcon} className="text-white text-2xl" />
                    </div>
                    <h2 className="text-3xl font-bold bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent">
                      رؤيتنا
                    </h2>
                  </div>
                  <p className={`text-lg leading-relaxed ${darkMode ? 'text-purple-100' : 'text-purple-900'}`}>
                    نطمح إلى أن تصبح Lkhadma المرجع الأول وطنياً في مجال التوظيف الرقمي، عبر حلول مبتكرة تُسهِم في تطوير سوق الشغل وتعزيز الاندماج المهني في المغرب.
                  </p>
                </motion.div>
              </div>
            </section>
            ...
            <section className="mb-20">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                {[
                  { icon: faLightbulb, title: 'التبسيط', desc: 'تبسيط عملية البحث عن العمل', color: 'from-yellow-500 to-orange-500' },
                  { icon: faRocket, title: 'التسريع', desc: 'تسريع عملية التوظيف للشركات', color: 'from-green-500 to-emerald-500' },
                  { icon: faProjectDiagram, title: 'الربط', desc: 'خلق فضاء يربط العرض بالطلب', color: 'from-blue-500 to-cyan-500' },
                  { icon: faHandshake, title: 'الدعم', desc: 'دعم المستخدمين بالمحتوى التوجيهي', color: 'from-purple-500 to-pink-500' }
                ].map((value, index) => (
                  <motion.div
                    key={index}
                    initial={{ opacity: 0, y: 20 }}
            ...
            <section className="mb-20">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                {[
                  { icon: faUser, title: 'تسجيل سهل', desc: 'إنشاء حساب ورفع السيرة الذاتية' },
                  { icon: faBuilding, title: 'خدمات الشركات', desc: 'نشر إعلانات وفلترة المرشحين' },
                  { icon: faGraduationCap, title: 'محتوى توجيهي', desc: 'مقالات ونصائح مهنية' },
                  { icon: faShield, title: 'مراقبة الجودة', desc: 'مراجعة يدوية وآلية للإعلانات' }
                ].map((step, index) => (
                  <motion.div
                    key={index}
                  ...
                  >
                    <div className="text-5xl font-bold text-slate-400 mb-4">0{index + 1}</div>
                    <div className={`w-12 h-12 rounded-lg bg-gradient-to-br from-orange-400 to-yellow-400 flex items-center justify-center mx-auto mb-4`}>
            ...
            <section className="mb-20">
              ...
              >
                <h2 className="text-4xl font-bold mb-4 bg-gradient-to-r from-emerald-400 to-green-400 bg-clip-text text-transparent">
                  الأمان والالتزام القانوني
                </h2>
              </motion.div>

              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {[
                  { icon: faBalanceScale, title: 'القانون المغربي 09-08', desc: 'الالتزام الكامل بقانون حماية المعطيات الشخصية' },
                  { icon: faShieldAlt, title: 'سياسة الخصوصية', desc: 'شفافية تامة في جمع واستخدام البيانات' },
                  { icon: faCode, title: 'شروط الاستخدام', desc: 'قواعد واضحة لبيئة آمنة ومحترمة' },
                  { icon: faMobileAlt, title: 'الأمن السيبراني', desc: 'أعلى مستوى من الحماية التقنية والتشفير' }
                ].map((item, index) => (
                  <motion.div
                    key={index}
                  ...
                  >
                    <div className="flex items-start">
                      <div className={`w-12 h-12 rounded-lg bg-gradient-to-br from-emerald-400 to-green-300 flex items-center justify-center ml-4`}>
            ...
            <section className="mb-20">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                <motion.div
                  ...
                  className={`rounded-3xl p-8 ${
                    darkMode
                      ? 'bg-gradient-to-br from-indigo-900/40 to-blue-900/20 border border-indigo-800/30'
                      : 'bg-gradient-to-br from-indigo-50 to-blue-50 border border-indigo-200/50'
                  }`}
                >
                  <div className="flex items-center mb-6">
                    <div className={`w-14 h-14 rounded-xl bg-gradient-to-br from-indigo-500 to-blue-400 flex items-center justify-center ml-4`}>
                      <FontAwesomeIcon icon={faUsersCog} className="text-white text-2xl" />
                    </div>
                  ...
                  <div className="space-y-3">
                    {['مدير المشروع', 'مسؤول تطوير الأعمال', 'مصمم UX/UI', 'فريق دعم العملاء', 'فريق التسويق الرقمي'].map((role, i) => (
                      <div key={i} className="flex items-center">
                        <FontAwesomeIcon icon={faCheckCircle} className="text-green-400 ml-3" />
                        <span className={darkMode ? 'text-blue-100' : 'text-slate-700'}>{role}</span>
                      </div>
                    ))}
                  </div>
                </motion.div>
                ...
                <motion.div
                  ...
                  className={`rounded-3xl p-8 ${
                    darkMode
                      ? 'bg-gradient-to-br from-cyan-900/40 to-teal-900/20 border border-cyan-800/30'
                      : 'bg-gradient-to-br from-cyan-50 to-teal-50 border border-cyan-200/50'
                  }`}
                >
                  <div className="flex items-center mb-6">
                    <div className={`w-14 h-14 rounded-xl bg-gradient-to-br from-cyan-500 to-teal-400 flex items-center justify-center ml-4`}>
                  ...
                  <div className="space-y-3">
                    {['اشتراكات للشركات', 'رسوم نشر الإعلانات', 'باقات مميزة للباحثين', 'إعلانات داخلية', 'خدمات إضافية'].map((item, i) => (
                      <div key={i} className="flex items-center">
                        <FontAwesomeIcon icon={faHandHoldingUsd} className="text-yellow-400 ml-3" />
                        <span className={darkMode ? 'text-blue-100' : 'text-slate-700'}>{item}</span>
                      </div>
                    ))}
                  </div>
                </motion.div>
            ...
            <section className="mb-20">
              ...
              >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  {[
                    { icon: faVideo, text: 'فيديوهات توعوية على TikTok وYouTube' },
                    { icon: faSearch, text: 'SEO وتحسين الظهور في محركات البحث' },
                    { icon: faHandshake, text: 'شراكات مع المدارس المهنية والـOFPTT' },
                    { icon: faBriefcase, text: 'تواصل مع الشركات الناشئة والمقاولات الصغرى' },
                    { icon: faUsers, text: 'إعلانات السوشيال ميديا المستهدفة' },
                    { icon: faRocket, text: 'حملات ترويجية موسمية' }
                  ].map((item, i) => (
                    <div key={i} className="flex items-center p-3 rounded-lg bg-black/5 dark:bg-white/5">
                      <FontAwesomeIcon icon={item.icon} className="text-purple-400 ml-3" />
                      <span className={darkMode ? 'text-blue-100' : 'text-slate-700'}>{item.text}</span>
                    </div>
                  ))}
                </div>
              </motion.div>
            ...
            >
              ...
              <p className={`text-xl mb-8 max-w-2xl mx-auto ${darkMode ? 'text-blue-200' : 'text-blue-800'}`}>
                ساهم معنا في بناء مستقبل أفضل لسوق العمل المغربي
              </p>
