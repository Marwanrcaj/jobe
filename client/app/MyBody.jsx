  ...
  const [data, setData] = useState([
    {
      id: 1,
      name: "Ahmed El Fassi",
      email: "ahmed.elfassi@google.com",
      phone: "+212 600 12 34 56",
      job: "Senior Software Engineer",
      company: "Google",
      location: "Casablanca",
      education: "École Mohammadia d'Ingénieurs",
    ...
    },
    {
      ...
      email: "fatima.benani@ibnrochd.ma",
      phone: "+212 600 23 45 67",
      job: "Medical Director",
      company: "Ibn Rochd Hospital",
      location: "Rabat",
      education: "University of Medicine, Paris",
      skills: ["Healthcare Management", "Surgery", "Research", "Public Health"],
      experience: "12 years",
      rating: 4.9,
      verified: true,
      premium: true,
    ...
    },
    {
      id: 3,
      name: "Karim Alami",
      email: "karim.alami@architecture.ma",
      phone: "+212 600 34 56 78",
      job: "Principal Architect",
      company: "Alami Architects",
      location: "Marrakech",
      education: "National School of Architecture",
      skills: ["Sustainable Design", "AutoCAD", "3D Modeling", "Project Management"],
      experience: "10 years",
      rating: 4.7,
      verified: true,
      premium: false,
    ...
    },
    {
      id: 4,
      name: "Nadia Berrada",
      email: "nadia.berrada@law.ma",
      phone: "+212 600 45 67 89",
      job: "Senior Partner",
      company: "Berrada & Associates",
      location: "Fes",
      education: "Harvard Law School",
      skills: ["Corporate Law", "M&A", "International Law", "Arbitration"],
      experience: "15 years",
      rating: 4.6,
      verified: true,
      premium: true,
    ...
    },
    {
      ...
      email: "mehdi.cherkaoui@finance.ma",
      phone: "+212 600 56 78 90",
      job: "Investment Director",
      company: "Attijariwafa Bank",
      location: "Casablanca",
      education: "HEC Paris",
      skills: ["Investment Banking", "Risk Analysis", "Portfolio Management", "FinTech"],
      experience: "9 years",
      rating: 4.5,
      verified: true,
      premium: false,
    ...
    },
    {
      id: 6,
      name: "Leila Amrani",
      email: "leila.amrani@education.ma",
      phone: "+212 600 67 89 01",
      job: "Professor of Computer Science",
      company: "Mohammed VI University",
      location: "Rabat",
      education: "PhD, MIT",
      skills: ["Machine Learning", "AI Research", "Data Science", "Academia"],
      experience: "8 years",
      rating: 4.8,
      verified: true,
      premium: true,
